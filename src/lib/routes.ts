...
export const buyLinkPath = (offering: string, fragment: string) => buyPath(offering) + '#' + fragment;

export function currentCreatePage(pathname: string = location.pathname): boolean {
...
export function currentVoucherFragment(hash: string = location.hash): string | null {
